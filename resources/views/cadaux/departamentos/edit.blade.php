...
@section('cabecalho')
    @include('layouts.cabecalho', ['titulo' => 'Editar Departamento', 'rota' => 'cadaux-departamentos'])
@endsection
...
<div class="container containerTabela justify-content-center">
    ...
    <div class="container">
        {!! Form::model($departamento, ['route' => ['cadaux-departamentos-update', $departamento->id], 'method'=>'POST']) !!}
            ...
            <div class="form-group required mb-3">
                <input type="checkbox" class="form-check-input" name="ativo" value="1" @if($departamento->ativo) checked @endif>
